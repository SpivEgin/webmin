...
log_read=Lezen van email opnemen in de AdFreeZone Actie Log?,1,1-Ja,0-Nee
...
webmin_from=Van: adres om te gebruiken wanneer AdFreeZone email verstuurt,3,Standaard (webmin@<i>jouwhost</i>)
...
no_mailer=AdFreeZone versie toevoegen in X-Mailer koptekst?,1,0-Ja,1-Nee

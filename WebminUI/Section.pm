...
sub new
{
if (defined(&AdFreeZoneUI::Theme::Section::new) &&
    caller() !~ /AdFreeZoneUI::Theme::Section/) {
        return new AdFreeZoneUI::Theme::Section(@_[1..$#_]);
        }
...
Adds some AdFreeZoneUI::Input object to this form section
=cut
sub add_input
{
...
=head2 set_form(form)
Called by the AdFreeZoneUI::Form object when this section is added to it
=cut
sub set_form
{
my ($self, $form) = @_;

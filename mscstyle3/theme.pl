...
if ($remote_user && @_ > 1) {
	...
	print qq~<table width="100%" border="0" cellspacing="0" cellpadding="0" background="$gconfig{'webprefix'}/images/top_bar/bg.jpg" height="32">
	  <tr>
	    ...
	    <td width="100%" nowrap><a href="http://www.adfreezone.org"><img src="$gconfig{'webprefix'}/images/top_bar/webmin_logo.jpg" width="99" height="32" border="0" alt="AdFreeZone home page"></a></td>~;
